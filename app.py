...
5. 기호·표기는 원문 그대로 유지하세요: 부등호(p<.05, t<2.0 등)를 등호로 바꾸거나
   지우지 말고, 꺾쇠괄호 표기(<표 1>, <그림 2>, <Figure 1> 등)도 제거·변경하지 마세요.
   통계 수치·기호는 문장만 다듬고 값과 기호 자체는 절대 바꾸지 마세요.
...
규칙 (반드시 지킬 것):
- 기호·표기는 원문 그대로 유지하세요: 부등호(p<.05, t<2.0 등)를 등호로 바꾸거나
  지우지 말고, 꺾쇠괄호 표기(<표 1>, <그림 2>, <Figure 1> 등)도 제거·변경하지 마세요.
  통계 수치·기호는 문장만 다듬고 값과 기호 자체는 절대 바꾸지 마세요.
